    ...
    return (
        <>
            <section className="relative h-80 md:h-100 overflow-hidden">
                ...
                <div
                    className="absolute inset-0 top-16 flex flex-col justify-center items-center z-20 text-center px-4">
                    <motion.img initial={{opacity: 0, y: 20}}
                                animate={{opacity: 1, y: [20, -5, 0]}}
                                transition={{duration: 1, ease: [0.4, 0.0, 0.2, 1]}} src={ticketImg}
                                alt={"Image of a ticket"} className={"size-24 md:size-30"}/>
                    <motion.h1
            ...
            >
                <g fill="#a684ff">
                    ...
                    ></path>
                    <path
                        d="M0 0v74.7C62 44 122.4 28.7 205 46c83.8 17.6 160.5 25.4 240-7 54-22 110-21 173-5 76.5 19.4 146.5 23.3 222 0 55-17 110.3-31.9 160-22.2V0H0Z"></path>
                </g>
            </svg>
